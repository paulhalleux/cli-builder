 ...
 */
export async function writeTemplate<TData extends object>(template: string, data?: TData, options?: WriteTemplateOptions) {
  ...
  if (options?.cleanEndOfLine) {
    parsed = cleanEOL(parsed);
  }
